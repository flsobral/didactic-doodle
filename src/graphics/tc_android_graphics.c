...
#endif
#if TC_ANDROID_GRAPHICS_VULKAN
int tc_android_vk_context_create(void* native_window, TcGraphicsContext** out_context);
int tc_android_vk_context_resize(TcGraphicsContext* context, int width, int height, float scale);
void tc_android_vk_context_destroy(TcGraphicsContext* context);
#endif
...
#endif
#if TC_ANDROID_GRAPHICS_VULKAN
    if (api == TC_GRAPHICS_VULKAN) return tc_android_vk_context_create(window->value, out_context);
#endif
...
#endif
#if TC_ANDROID_GRAPHICS_VULKAN
    else if (context->api == TC_GRAPHICS_VULKAN) tc_android_vk_context_resize(context, width, height, scale);
#endif
}
...
#endif
#if TC_ANDROID_GRAPHICS_VULKAN
    else if (context->api == TC_GRAPHICS_VULKAN) tc_android_vk_context_destroy(context);
#endif
}
#endif
