...
const char *doodle_renderer_name(const DoodleRenderer *renderer) { return renderer && renderer->provider && renderer->provider->name ? renderer->provider->name : "unknown"; }
const char *doodle_renderer_version(const DoodleRenderer *renderer) { return renderer && renderer->provider && renderer->provider->version ? renderer->provider->version : "unknown"; }
