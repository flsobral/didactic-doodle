...
typedef struct MagicOpenGLBackend { BoardSurfaceOpenGLInterface surface; void *context; char version[128]; } MagicOpenGLBackend;
...
const char *magic_opengl_backend_version(const MagicContext *context) { const MagicOpenGLBackend *backend = context ? context->backend_data : NULL; return backend && backend->version[0] ? backend->version : "unknown"; }
