...
typedef struct BoardBackendConfig { uint32_t struct_size; uint32_t abi_version; BoardBackendKind kind; const char *title; uint32_t width, height; float scale; uint8_t resizable; } BoardBackendConfig;
